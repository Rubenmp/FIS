...
En este documento se adjuntan algunos de los contratos de las operaciones del sistema \textit{Tapuntas}, basándonos el en modelo
conceptual adjunto a la práctica.

%\section{Diagramas realizados por Alicia Rodríguez Gómez}
%\includepdf[pages=-]{./Contratos/Alicia.pdf}
%\newpage

\section{Diagramas realizados por Francisco Javier Morales Piqueras}
\includepdf[pages=-]{./Contratos/Fran.pdf}
\newpage

\section{Diagramas realizados por Rubén Morales Pérez}
\includepdf[pages=-]{./Contratos/RubMorPer.pdf}
\newpage

\section{Diagramas realizados por Samia Mikou}
\includepdf[pages=-]{./Contratos/SamiaMikou.pdf}
\newpage
