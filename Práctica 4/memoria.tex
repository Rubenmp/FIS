...
\begin{figure}[H]
	\includegraphics[width=0.7\textwidth]{./DiagramasComunicacion/Ruben-altaRegistro.jpg}
	\caption{Alta registro}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=0.7\textwidth]{./DiagramasComunicacion/Ruben-solicitarBajaRegistro.jpg}
	\caption{Solicitar baja registro}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=0.7\textwidth]{./DiagramasComunicacion/Ruben-obtenerDatosUsuario.jpg}
	\caption{Obtener datos usuario}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=0.7\textwidth]{./DiagramasComunicacion/Ruben-introducirPerfil.jpg}
	\caption{Introducir perfil}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=0.7\textwidth]{./DiagramasComunicacion/Ruben-consultarPerfil.jpg}
...
\begin{figure}[H]
	\includegraphics[width=0.7\textwidth]{./DiagramasComunicacion/Alicia/establecerFormaPago.jpg}
	\caption{Establecer forma pago}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=0.7\textwidth]{./DiagramasComunicacion/Alicia/AniadirVehiculo.jpg}
	\caption{Añadir vehículo}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=0.7\textwidth]{./DiagramasComunicacion/Alicia/eliminarVehiculo.jpg}
	\caption{Eliminar vehículo}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=0.7\textwidth]{./DiagramasComunicacion/Alicia/definirPlanAlquiler.jpg}
...
\begin{figure}[H]
	\includegraphics[width=0.7\textwidth]{./DiagramasComunicacion/Fran1.jpg}
	\caption{}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=0.7\textwidth]{./DiagramasComunicacion/Fran2.jpg}
	\caption{}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=0.7\textwidth]{./DiagramasComunicacion/Fran3.jpg}
	\caption{}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=0.7\textwidth]{./DiagramasComunicacion/Fran4.jpg}
	\caption{}
\end{figure}
\newpage
...
\begin{figure}[H]
	\includegraphics[width=0.7\textwidth]{./DiagramasComunicacion/}
